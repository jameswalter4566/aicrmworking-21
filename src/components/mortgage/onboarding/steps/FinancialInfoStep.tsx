  ...
  const { register, watch, handleSubmit, control } = useForm({
    defaultValues: {
      primaryEmployment: {
        ...
        industry: leadData.mortgageData?.employment?.industry || "",
        employerPhone: leadData.mortgageData?.employment?.employerPhone || "",
        startMonth: "",
        startYear: "",
        isFamilyMember: leadData.mortgageData?.employment?.isFamilyMember || false,
        incomeBase: leadData.mortgageData?.income?.baseIncome || "",
        incomeOvertime: leadData.mortgageData?.income?.overtimeIncome || "",
        incomeBonus: leadData.mortgageData?.income?.bonusIncome || "",
        incomeCommission: leadData.mortgageData?.income?.commissionIncome || "",
        incomeOther: leadData.mortgageData?.income?.otherIncome || ""
      },
      coApplicantEmployment: {
        employmentType: leadData.mortgageData?.coApplicant?.employmentType || "",
        employerName: leadData.mortgageData?.coApplicant?.employerName || "",
        employerStreet: leadData.mortgageData?.coApplicant?.employerAddress || "",
        employerCity: "",
        employerState: "",
        employerZipcode: "",
        positionTitle: leadData.mortgageData?.coApplicant?.jobTitle || "",
        industry: leadData.mortgageData?.coApplicant?.industry || "",
        employerPhone: leadData.mortgageData?.coApplicant?.employerPhone || "",
        startMonth: "",
        startYear: "",
        isFamilyMember: leadData.mortgageData?.coApplicant?.isFamilyMember || false,
        incomeBase: leadData.mortgageData?.coApplicant?.income?.baseIncome || "",
        incomeOvertime: leadData.mortgageData?.coApplicant?.income?.overtimeIncome || "",
        incomeBonus: leadData.mortgageData?.coApplicant?.income?.bonusIncome || "",
        incomeCommission: leadData.mortgageData?.coApplicant?.income?.commissionIncome || "",
        incomeOther: leadData.mortgageData?.coApplicant?.income?.otherIncome || ""
      }
    }
  });
